function writeRestaurants() {
    ...
    restaurantTempData.add({
        ...
        longitude: -127.71884,
        recently_visited: 53,
        details: "Dine amidst lush gardens at Cafe Two." 
        + "Enjoy farm-fresh cuisine in a serene oasis.", 
    ...
    restaurantTempData.add({
        ...
        + " A symphony of flavors awaits in an opulent setting. Elegance"
        + "in every bite.",
    ...
    restaurantTempData.add({
        ...
        recently_visited: 512,
        details: "Experience culinary artistry at FancyRestaurant 2."
        + " Exquisite dishes, impeccable service, and a luxurious"
        + " ambiance define your extraordinary dining journey.",
