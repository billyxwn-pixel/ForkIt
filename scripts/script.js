// Function for the onclick of the logout button
function logout() {
...
// Function to display restaurant cards on the index page
function displayCardsDynamically(collection) {
    // Create a template for use later
    ...
    .then(allRest=> {
        allRest.forEach(doc => {
            ...
            // Pull all the needed information from the restaurant document, populate in the card
            // and appends it to the card display div
